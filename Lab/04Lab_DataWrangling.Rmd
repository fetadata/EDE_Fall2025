...
NTL.phys.data.1990s <- filter(NTL.phys.data,
...
NTL.phys.data.IrradianceLong <- 
  pivot_longer(data = NTL.phys.data, cols= irradianceWater:irradianceDeck, 
...
NTL.phys.data.TempC <- 
  pivot_wider(data=NTL.phys.data, id_cols = sampledate, names_from = depth, values_from = temperature_C)
