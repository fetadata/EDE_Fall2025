...
can be found here: - Overview: <https://here.r-lib.org> - Github repo:
...
2.  Refer to the example code shown here
    (<https://people.duke.edu/~jpfay/ENV872/here.html>) to read in all
    CSV files starting with "EPAair_O3" into a single dataframe.
