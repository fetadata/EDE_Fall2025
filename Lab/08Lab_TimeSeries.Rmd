...
Rain.Plot <- ggplot(BR_complete, aes(x=Date, y=Rainfall))+
  geom_line()+
  geom_smooth(linetype=4)
Rain.Plot

Temp.Plot <- ggplot(BR_complete, aes(x=Date, y=Temperature_C))+
  geom_line()+
...
#use this as a backup in case you don't know the first month/year and use this as your start
