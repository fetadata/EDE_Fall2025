...
```{r data.summary, echo=FALSE, warning=FALSE, error=FALSE,}
...
```{r 2018 Ozone, echo=FALSE,warning=FALSE, error=FALSE, fig.align='left',fig.height=3,fig.cap="2018 Ozone Concentration by Month"}
Ozone2018 <- epa_data %>% 
  filter(Year == 2018) 
  

O_2018_Boxplot <- ggplot(Ozone2018)+
  geom_boxplot(aes(factor(Month, labels = month.abb), Ozone))+
...
```{r 2019 Ozone, echo=FALSE,warning=FALSE, error=FALSE, fig.align='left',fig.height=3,fig.cap="2019 Ozone Concentration by Month"}
Ozone2019 <- epa_data %>% 
  filter(Year == 2019) 
  

O_2019_Boxplot <- ggplot(Ozone2019)+
  geom_boxplot(aes(factor(Month, labels = month.abb), Ozone))+
...
# Statement of No AI Usage
I, Joshua Salzberg, of relatively sound mind, do hereby declare and promise I have not used AI to complete this assignment. 
