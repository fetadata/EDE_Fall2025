...
NTL.phys.data.Tuesday90s <- filter(NTL.phys.data, 
...
> Answer: row numbers could be changed via sub-selection, or the source data may change and it would not be reproducible! 
...
ntl.phys.data.tempdesc <- arrange(NTL.phys.data, desc(temperature_C))
